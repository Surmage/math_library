...
namespace Math {
	...
	public:
		...
		float determinant(const Mat4 m) {
			...
			+m.matrix[1].w*(m.matrix[2].y*m.matrix[3].z - m.matrix[2].z * m.matrix[3].y)) //corrected
			...
			+m.matrix[1].w * (m.matrix[2].x*m.matrix[3].z - m.matrix[2].z * m.matrix[3].x)) //corrected
			...
			+m.matrix[1].w*(m.matrix[2].x*m.matrix[3].y - m.matrix[2].y * m.matrix[3].x)) //corrected
			...
			+m.matrix[1].z * (m.matrix[2].x * m.matrix[3].y - m.matrix[2].y * m.matrix[3].x) //corrected
